...
function showHeatmap() {
	...
	heatmapFinds = new L.ImageOverlay.WMS(GEOSERVER_WMS, options);
...
var trajek_wima14_1;
var trajek_wima14_2;
var trajek_sommerfest2014;

function createTraj(){
	console.log(GEOSERVER_WMS);
	trajek_ajf = L.tileLayer.wms(GEOSERVER_WMS, {
	...
	trajek_infotag = L.tileLayer.wms(GEOSERVER_WMS, {
		layers: 'openballoon:trajektorien_fhinfotag',
		format: 'image/png',
		transparent: true,
		attribution: "Trajektorien &copy; HYSPLIT (HYbrid Single-Particle Lagrangian Integrated Trajectory) Model access via NOAA ARL READY Website"
	});
	trajek_infotag2 = L.tileLayer.wms(GEOSERVER_WMS, {
		layers: 'openballoon:trajektorien_hsinfotag_2015',
		format: 'image/png',
		transparent: true,
		attribution: "Trajektorien &copy; HYSPLIT (HYbrid Single-Particle Lagrangian Integrated Trajectory) Model access via NOAA ARL READY Website"
	});
	trajek_hochzeit = L.tileLayer.wms(GEOSERVER_WMS, {
		layers: 'openballoon:trajektorien_boochs',
		format: 'image/png',
		transparent: true,
		attribution: "Trajektorien &copy; HYSPLIT (HYbrid Single-Particle Lagrangian Integrated Trajectory) Model access via NOAA ARL READY Website"
	});
	trajek_wima14_1 = L.tileLayer.wms(GEOSERVER_WMS, {
		layers: 'openballoon:trajektorien_wima14_1',
		format: 'image/png',
		transparent: true,
		attribution: "Trajektorien &copy; HYSPLIT (HYbrid Single-Particle Lagrangian Integrated Trajectory) Model access via NOAA ARL READY Website"
	});
	trajek_wima14_2 = L.tileLayer.wms(GEOSERVER_WMS, {
		layers: 'openballoon:trajektorien_wima14_2',
		format: 'image/png',
		transparent: true,
		attribution: "Trajektorien &copy; HYSPLIT (HYbrid Single-Particle Lagrangian Integrated Trajectory) Model access via NOAA ARL READY Website"
	});
	trajek_sommerfest2014 = L.tileLayer.wms(GEOSERVER_WMS, {
